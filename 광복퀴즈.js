const problems = [
  ...
  { img: "pictures/13-문제 13.png", answer: 1 },
  { img: "pictures/14-문제 14.png", answer: 1 },
  { img: "pictures/15-문제 15.png", answer: 1 },
  { img: "pictures/16-문제 16.png", answer: 1 },
...
function showResult() {
  let level = "";
  const percent = (score / problems.length) * 100;
  if (percent === 100) {
    level = "광복절 마스터";
  } else if (percent >= 90) {
    level = "역사 지킴이";
  ...
  document.querySelector('.quiz-area').innerHTML =
    `<div style="font-size:1.3em; font-weight:bold;">퀴즈 완료!</div>
     <div style="margin:18px 0;">총 점수: ${score} / ${problems.length}</div>
